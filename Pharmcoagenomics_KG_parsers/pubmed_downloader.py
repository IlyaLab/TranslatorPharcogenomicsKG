...
_URLs = [f"https://ftp.ncbi.nlm.nih.gov/pubmed/baseline/pubmed26n{i:04d}.xml.gz" for i in range(1, 1220)]
...
class Pubmed(datasets.GeneratorBasedBuilder):
    ...
    BUILDER_CONFIGS = [
        datasets.BuilderConfig(name="2026", description="The 2026 annual record", version=datasets.Version("4.0.0")),
    ]
